...
public class SignUp4DealTest extends TestBase {
	...
	public void verifySignUp4DealsTest() {
		signUp.verifySignUp("shuwaibliaquat@hotmail.com", "shuwaibliaquat@hotmail.com", 
				"123456", "Shuwaib", "Liaquat", "07035", "01291989", 
				"8", "Chapel hill rd", 
				"Lincoln Park", "NJ", "07035");
	}
	
	@Test(priority=3,dataProvider = "getCVSTestDataSignUp4Savings")
	public void verifySignU4DealsExcelDataTest(String emailAddress, String reEnterEmailAddress, 
			String ExtraCareNum, String FirstName, String LastName, 
			String zipCode, String DOB, String addLine1, String addLine2, 
			String city, String state, String zipCode2) {
		log.info("Beginnning of Excel Data Test");
		signUp.verifySignUp(emailAddress, reEnterEmailAddress, ExtraCareNum, 
				FirstName, LastName, zipCode, DOB, addLine1, addLine2, 
				city, state, zipCode2);
	}
