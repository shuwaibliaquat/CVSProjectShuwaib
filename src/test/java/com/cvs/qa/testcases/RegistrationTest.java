...
public class RegistrationTest extends TestBase {
	...
	public void verifyRegistrationPageTitle() {
		...
		//Assert.assertEquals(RegTitle, "Create Your CVS Account");//Bug (expected [Create Your CVS Account] but found [Registration Optimization])
	}
	
	@Test(priority=1)
	public void registerCustomer() throws InterruptedException{
		registration.registrationForm("Shuwaib", "Liaquat", "shuwaibliaquat@hotmail.com", 
		...
		registration.registrationForm2ndPart("Chapel Hill Rd", "24", "LinColn Park", 
				"07503", "2012592479", "01","29", "1989");
	...
	public void registerMultipleCustomer(String FirstName, String LastName, String EmailAddress, String Pwd, String CPwd,String Name, String StreetAddress, String Apt, 
			String City, String State, String ZipCode, String PhoneNumber, String Month, String Day, String Year, String Gender) throws Exception {
